-- *** BUILDER: START OF FILE ***
-- THIS IS AN AUTO-GENERATED FILE
-- BUILT FROM THE DIFFERENT FILES OF YALG
-- BY AN AUTOMATIC BUILD TOOL
-- DO NOT EDIT THIS FILE DIRECTLY!
--
-- TIMESTAMP: 2020. August 25. 23:52:15
-- LATEST COMMIT HASH: 86885b7f2308f1666351f7846aca508a1a823150


-- *** BUILDER: SECTION START ***
-- *** THIS SECTION IS SOURCED FROM FILE "Classic.lua" ***
...
-- *** BUILDER: SECTION START ***
-- *** THIS SECTION IS SOURCED FROM FILE "utils.lua" ***
...
-- *** BUILDER: SETTING IMPORT ALIAS ***
local U = utils


-- *** BUILDER: SECTION START ***
-- *** THIS SECTION IS SOURCED FROM FILE "WidgetBase.lua" ***
...
-- *** BUILDER: SECTION START ***
-- *** THIS SECTION IS SOURCED FROM FILE "ContainerBase.lua" ***
...
-- *** BUILDER: SECTION START ***
-- *** THIS SECTION IS SOURCED FROM FILE "Switcher.lua" ***
...
-- *** BUILDER: SECTION START ***
-- *** THIS SECTION IS SOURCED FROM FILE "Label.lua" ***
...
-- *** BUILDER: SECTION START ***
-- *** THIS SECTION IS SOURCED FROM FILE "Button.lua" ***
...
-- *** BUILDER: SECTION START ***
-- *** THIS SECTION IS SOURCED FROM FILE "HDiv.lua" ***
...
-- *** BUILDER: SECTION START ***
-- *** THIS SECTION IS SOURCED FROM FILE "VDiv.lua" ***
...
-- *** BUILDER: SECTION START ***
-- *** THIS SECTION IS SOURCED FROM FILE "GUI.lua" ***
...
-- *** BUILDER: SECTION START ***
-- *** THIS SECTION IS SOURCED FROM FILE "yalg.lua" ***
...
local YALG = {
-- *** BUILDER: CHANGED ***
-- ORIGINAL: "    GUI = require("GUI"),"
GUI = GUI,
-- *** BUILDER: CHANGED ***
-- ORIGINAL: "    VDiv = require("VDiv"),"
VDiv = VDiv,
-- *** BUILDER: CHANGED ***
-- ORIGINAL: "    HDiv = require("HDiv"),"
HDiv = HDiv,
-- *** BUILDER: CHANGED ***
-- ORIGINAL: "    Button = require("Button"),"
Button = Button,
-- *** BUILDER: CHANGED ***
-- ORIGINAL: "    Label = require("Label"),"
Label = Label,
-- *** BUILDER: CHANGED ***
-- ORIGINAL: "    Switcher = require("Switcher"),"
Switcher = Switcher,
    Font = U.Font,
    rgb = U.rgb,
}
